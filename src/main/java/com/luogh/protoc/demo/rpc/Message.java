...
package com.luogh.protoc.demo.rpc;
...
public final class Message {
  ...
  public interface RequestOrBuilder
     ...
     * </pre>
     */
    Message.ParamsOrBuilder getParamsOrBuilder();
  }
  /**
  ...
  public static final class Request extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              Message.Params.Builder subBuilder = null;
              if (((bitField0_ & 0x00000004) == 0x00000004)) {
                subBuilder = params_.toBuilder();
              }
              params_ = input.readMessage(Message.Params.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    private Message.Params params_;
    /**
     * <code>optional .Params params = 3;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    public Message.Params getParams() {
      return params_;
    }
    /**
     * <code>optional .Params params = 3;</code>
     ...
     * </pre>
     */
    public Message.ParamsOrBuilder getParamsOrBuilder() {
      return params_;
    }
    ...
    private void initFields() {
      serviceName_ = "";
      methodName_ = "";
      params_ = Message.Params.getDefaultInstance();
    }
    ...
    public static final class Builder extends
       ...
       implements Message.RequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Message.internal_static_Request_descriptor;
      }
  ...
  bitField0_ |= 0x00000002;
      ...
      // optional .Params params = 3;
      private Message.Params params_ = Message.Params.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
          Message.Params, Message.Params.Builder, Message.ParamsOrBuilder> paramsBuilder_;
      /**
       * <code>optional .Params params = 3;</code>
       *
       * <pre>
       ...
       * </pre>
       */
      public Builder setParams(Message.Params value) {
        if (paramsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setParams(
          Message.Params.Builder builderForValue) {
        if (paramsBuilder_ == null) {
       ...
       * </pre>
       */
      public Builder mergeParams(Message.Params value) {
        if (paramsBuilder_ == null) {
          if (((bitField0_ & 0x00000004) == 0x00000004) &&
              params_ != Message.Params.getDefaultInstance()) {
            params_ =
              Message.Params.newBuilder(params_).mergeFrom(value).buildPartial();
          } else {
            params_ = value;
          }
          onChanged();
       ...
       * </pre>
       */
      public Message.Params.Builder getParamsBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          Message.Params, Message.Params.Builder, Message.ParamsOrBuilder>
          getParamsFieldBuilder() {
        if (paramsBuilder_ == null) {
  ...
  public static final class Params extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Message.internal_static_Params_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Message.internal_static_Params_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Message.Params.class, Message.Params.Builder.class);
    }
    ...
    public static Message.Params parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Message.Params parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Message.Params parseFrom(
    ...
    public static Message.Params parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Message.Params parseFrom(
    ...
    public static Message.Params parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Message.Params parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Message.Params prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements Message.ParamsOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Message.internal_static_Params_descriptor;
      }
      ...
      public Message.Params getDefaultInstanceForType() {
        return Message.Params.getDefaultInstance();
      }

      public Message.Params build() {
        Message.Params result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Message.Params buildPartial() {
        Message.Params result = new Message.Params(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Message.Params) {
          return mergeFrom((Message.Params)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Message.Params other) {
        if (other == Message.Params.getDefaultInstance()) return this;
        if (other.hasKey()) {
          bitField0_ |= 0x00000001;
          key_ = other.key_;
          onChanged();
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Message.Params parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Message.Params) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  public static final class Response extends
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements Message.ResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Message.internal_static_Response_descriptor;
      }
  ...
  public static abstract class RpcService
    ...
    public interface Interface {
      ...
      public abstract void call(
          ...
          com.google.protobuf.RpcCallback<Message.Response> done);
      ...
      return new com.google.protobuf.BlockingService() {
        ...
        public final com.google.protobuf.Message callBlockingMethod(
          ...
          switch(method.getIndex()) {
            case 0:
              return impl.call(controller, (Message.Request)request);
            default:
    ...
    public static final
        ...
        getDescriptor() {
      return Message.getDescriptor().getServices().get(0);
    }
    public final com.google.protobuf.Descriptors.ServiceDescriptor
        getDescriptorForType() {
      return getDescriptor();
    ...
    public final void callMethod(
      ...
      switch(method.getIndex()) {
        case 0:
          this.call(controller, (Message.Request)request,
            com.google.protobuf.RpcUtil.<Message.Response>specializeCallback(
              done));
          return;
        default:
          throw new java.lang.AssertionError("Can't get here.");
    ...
    public static final class Stub extends Message.RpcService implements Interface {
      ...
      public  void call(
        ...
        channel.callMethod(
          ...
          controller,
          request,
          Message.Response.getDefaultInstance(),
    ...
    private static final class BlockingStub implements BlockingInterface {
      ...
      public Message.Response call(
          ...
          Message.Request request)
          throws com.google.protobuf.ServiceException {
        return (Message.Response) channel.callBlockingMethod(
          getDescriptor().getMethods().get(0),
          controller,
          request,
          Message.Response.getDefaultInstance());
  ...
  public static abstract class ReplyService
    ...
    public interface Interface {
      ...
      public abstract void call(
          com.google.protobuf.RpcController controller,
          Message.Msg request,
          com.google.protobuf.RpcCallback<Message.Msg> done);
    ...
    public static com.google.protobuf.BlockingService
      ...
      return new com.google.protobuf.BlockingService() {
        ...
        public final com.google.protobuf.Message callBlockingMethod(
          ...
          switch(method.getIndex()) {
            case 0:
              return impl.call(controller, (Message.Msg)request);
            default:
              throw new java.lang.AssertionError("Can't get here.");
          }
        }
    ...
    public static final
        com.google.protobuf.Descriptors.ServiceDescriptor
        getDescriptor() {
      return Message.getDescriptor().getServices().get(1);
    }
    public final com.google.protobuf.Descriptors.ServiceDescriptor
        getDescriptorForType() {
      return getDescriptor();
    ...
    public final void callMethod(
      ...
      switch(method.getIndex()) {
        case 0:
          this.call(controller, (Message.Msg)request,
            com.google.protobuf.RpcUtil.<Message.Msg>specializeCallback(
              done));
          return;
        default:
          throw new java.lang.AssertionError("Can't get here.");
    ...
    public static final class Stub extends Message.ReplyService implements Interface {
      private Stub(com.google.protobuf.RpcChannel channel) {
        this.channel = channel;
      }
      ...
      public  void call(
        ...
        channel.callMethod(
          ...
          controller,
          request,
          Message.Msg.getDefaultInstance(),
          com.google.protobuf.RpcUtil.generalizeCallback(
            done,
            Message.Msg.class,
            Message.Msg.getDefaultInstance()));
    ...
    private static final class BlockingStub implements BlockingInterface {
      ...
      public Message.Msg call(
          ...
          Message.Msg request)
          throws com.google.protobuf.ServiceException {
        return (Message.Msg) channel.callBlockingMethod(
          getDescriptor().getMethods().get(0),
          controller,
          request,
          Message.Msg.getDefaultInstance());
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\034src/main/proto/message.proto\"K\n\007Reques" +
      ...
      ")\n\nRpcService\022\033\n\004call\022\010.Request\032\t.Respon" +
      "se2\"\n\014ReplyService\022\022\n\004call\022\004.Msg\032\004.MsgB*" +
      "\n\034cn.slimsmart.protoc.demo.rpcB\007Message\210" +
      "\001\001"
    };
